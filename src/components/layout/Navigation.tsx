...
export function Navigation() {
  return (
    <nav className="fixed bottom-0 left-0 right-0 bg-stone-50/70 backdrop-blur-xl safe-area-pb">
      <div className="max-w-lg mx-auto flex justify-around pt-3 pb-2">
